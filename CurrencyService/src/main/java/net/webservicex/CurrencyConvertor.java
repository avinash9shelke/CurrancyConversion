    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(net.webservicex.CurrencyConvertor.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = net.webservicex.CurrencyConvertor.class.getResource(".");
